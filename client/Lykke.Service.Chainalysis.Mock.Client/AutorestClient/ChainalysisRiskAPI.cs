...
namespace Lykke.Service.ChainalysisMock.Client.AutorestClient
{
    ...
    public partial class ChainalysisRiskAPI : ServiceClient<ChainalysisRiskAPI>, IChainalysisRiskAPI
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IUserTransactionInfo>> UserByUserIdOutputsReceivedGetWithHttpMessagesAsync(string userId, string token, string status = default(string), int? limit = default(int?), int? offset = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (userId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "userId");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IUserInfo>> UserGetWithHttpMessagesAsync(string token, int? maxIdleDays = default(int?), string score = default(string), int? limit = default(int?), int? offset = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (token == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "token");
            ...
            if (score != null)
            {
                _queryParameters.Add(string.Format("score={0}", System.Uri.EscapeDataString(score)));
            }
            if (limit != null)
            {
                _queryParameters.Add(string.Format("limit={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(limit, SerializationSettings).Trim('"'))));
