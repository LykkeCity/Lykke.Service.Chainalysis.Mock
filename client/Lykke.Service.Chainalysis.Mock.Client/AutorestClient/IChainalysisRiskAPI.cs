...
namespace Lykke.Service.ChainalysisMock.Client.AutorestClient
{
    ...
    public partial interface IChainalysisRiskAPI : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<IUserTransactionInfo>> UserByUserIdOutputsReceivedGetWithHttpMessagesAsync(string userId, string token, string status = default(string), int? limit = default(int?), int? offset = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<IUserInfo>> UserGetWithHttpMessagesAsync(string token, int? maxIdleDays = default(int?), string score = default(string), int? limit = default(int?), int? offset = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
